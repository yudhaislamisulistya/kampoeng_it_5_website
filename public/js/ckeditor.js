    ...
    return function (t) {
        ...
        class to {
            ...
            getTrimmed() {
                ...
                let e = this.end.getLastMatchingPosition(eo, {
                    direction: "backward"
                });
                const n = t.nodeAfter,
                    i = e.nodeBefore;
        ...
        class io {
            ...
            setTo(t, e, n) {
                ...
                else if (t instanceof io || t instanceof oo) this._setRanges(t.getRanges(), t.isBackward), this._setFakeOptions({
                    fake: t.isFake,
            ...
            _pushRange(t) {
                for (const e of this._ranges)
                    if (t.isIntersecting(e)) throw new Qn.b("view-selection-range-intersects: Trying to add a range that intersects with another range from selection.", this, {
                        addedRange: t,
                        intersectingRange: e
                    });
            ...
            _getTouchingInlineDomNode(t, e) {
                ...
                const n = e ? "nextNode" : "previousNode",
                    ...
                    r = i.createTreeWalker(o, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {
                        acceptNode: t => jo(t) ? NodeFilter.FILTER_ACCEPT : "BR" == t.tagName ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
                    });
                r.currentNode = t;
                const s = r[n]();
                if (null !== s) {
        ...
        class Ps {
            constructor(t) {
                ...
                if (Object.defineProperty(this, "_source", {
                        ...
                        writable: !0,
                        enumerable: !1
                    }), Yn(t) || e) Ss(this, e ? Ps.getDomRangeRects(t)[0] : t.getBoundingClientRect());
                else if (hr(t)) {
                    const {
                        innerWidth: e,
                        innerHeight: n
        ...
        class Ks {
            ...
            get parent() {
                ...
                for (let e = 0; e < this.path.length - 1; e++)
                    if (t = t.getChild(t.offsetToIndex(this.path[e])), !t) throw new Qn.b("model-position-path-incorrect: The position's path is incorrect.", this, {
                        position: this
                    });
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item,
                        n = {
                            item: t,
                            range: Js._createFromPositionAndShift(e.previousPosition, e.length)
                        };
        ...
        class ia {
            ...
            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++)
                    if (t.isIntersecting(this._ranges[e])) throw new Qn.b("model-selection-range-intersects: Trying to add a range that intersects with another range in the selection.", [this, t], {
                        addedRange: t,
            ...
            constructor(t) {
                super(), this.markers = new ro({
                    ...
                    for (const t of this.getRanges())
                        if (!this._document._validateSelectionRange(t)) throw new Qn.b("document-selection-wrong-position: Range from document selection starts or ends at incorrect position.", this, {
                            range: t
                        })
        ...
        class Ia {
            ...
            get(t) {
                ...
                if (!e) {
                    ...
                    let n = t;
                    throw "function" == typeof t && (n = t.pluginName || t.name), new Qn.b(e, this._editor, {
                        plugin: n
                    })
                }
                return e
            ...
            init(t, e = []) {
                ...
                if (c) {
                    ...
                    return console.error(Object(Qn.a)(t), {
                        plugins: c
                    }), Promise.reject(new Qn.b(t, this._editor, {
                        plugins: c
                    }))
                }
        ...
        class za {
            ...
            _checkContextMatch(t, e, n = e.length - 1) {
                ...
                for (const o of t.getItems({
                        shallow: !0
                    })) o.is("element") && (yield* this._getValidRangesForRange(Js._createIn(o), e)), this.checkAttribute(o, e) || (n.isEqual(i) || (yield new Js(n, i)), n = Ks._createAfter(o)), i = Ks._createAfter(o);
        ...
        function Fa(t, e) {
            ...
            return function (t, e) {
                ...
                }(t, n), Ga(t, n, "allowIn"), Ga(t, n, "allowContentOf"), Ga(t, n, "allowWhere"), Ga(t, n, "allowAttributes"), Ga(t, n, "allowAttributesOf"), Ga(t, n, "inheritTypesFrom"),
                function (t, e) {
                    for (const n of t) {
        ...
        class tc {
            ...
            elementToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of ec(t)) this.for("upcast").elementToElement({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of ec(t)) this.for("upcast").elementToAttribute({
                    view: n,
                    model: e,
                    converterPriority: t.converterPriority
                })
            ...
            attributeToAttribute(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of ec(t)) this.for("upcast").attributeToAttribute({
                    view: n,
                    model: e
                })
            }
        ...
        class Vc {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Rc(this), this.selection = new ua(this), this.roots = new ro({
                    idProperty: "rootName"
                }), this.differ = new Ec(t.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", jc), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
                    if (n.isDocumentOperation && n.baseVersion !== this.version) throw new Qn.b("model-document-applyOperation-wrong-version: Only operations with matching versions can be applied.", this, {
                        operation: n
                    })
                }, {
                    priority: "highest"
        ...
        class Cl {
            ...
            revert(t) {
                ...
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) Fl(n) ? yield n: Ul(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = B(n[0]) && n[0].ns ? n[0].ns : null, El(n)) {
                        ...
                        s && ql(e) && a.unshift(i), this._bindToObservable({
                            schema: a,
                            updater: Ol(r, e, o),
                            data: t
                        })
            ...
            _renderElementChildren(t) {
                ...
                for (const r of this.children)
                    ...
                    } else if (Fl(r)) i || (r.isRendered || r.render(), n.appendChild(r.element));
        ...
        function Ll(t) {
            if ("string" == typeof t ? t = function (t) {
                ...
                const e = [];
                if (t.children)
                    if (Hl(t.children)) e.push(t.children);
                    else
                        for (const n of t.children) Ul(n) || Fl(n) || Zo(n) ? e.push(n) : e.push(new Cl(n));
                t.children = e
            }
            return t
        }
        ...
        function _d(t, e = gd) {
            const n = new e(t),
                i = new rd(t),
                o = new ld(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof gd ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"),
                function (t) {
                    (function (t) {
                        t.on("render", () => {
                            kd({
        ...
        class xd extends Wl {
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new nd) : e.has(t) ? this.items.add(e.create(t)) : console.warn(Object(Qn.a)("toolbarview-item-unavailable: The requested toolbar item is unavailable."), {
                        name: t
                    })
                })
            }
        ...
        class Cd {
            ...
            get _areItemsOverflowing() {
                ...
                if (!this.cachedPadding) {
                    const n = ir.window.getComputedStyle(t),
        ...
        class Pd extends Gl {
            constructor(t, e, n = {}) {
                super(t), this.stickyPanel = new Xl(t), this.toolbar = new xd(t, {
                    shouldGroupWhenFull: n.shouldToolbarGroupWhenFull
                }), this.editable = new Kl(t, e)
            }
            render() {
        ...
        class Sd extends cl {
            constructor(t, e) {
                ...
                const n = !this.config.get("toolbar.shouldNotGroupWhenFull"),
                    i = new Pd(this.locale, this.editing.view, {
                        shouldToolbarGroupWhenFull: n
                    });
                this.ui = new xl(this, i),
                    function (t) {
                ...
                t.change(n => {
                    ! function (t, e, n, i) {
                        ...
                        if (o) {
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), i && (o ? Vd(e, n.focus) : e.setSelection(a, 0))
                        }
                ...
                t.change(n => {
                    ! function (t, e, n) {
                        ...
                        if (i) {
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), a ? Ud(e, n.focus) : i && e.setSelection(s, 0)
                        }
        ...
        class Jd {
            ...
            handle(t, e) {
                if (function (t) {
                        ...
                        for (const e of t)
                            if ("children" === e.type && !Qd(e)) return !0;
                        return !1
        ...
        class nh extends mr {
            constructor(t) {
                ...
                e.on("keyup", (t, e) => {
                    ...
                    const o = {};
                    if (e.keyCode == wo.delete) o.direction = "forward", o.unit = "character";
                    else {
        ...
        function dh(t, e, n) {
            ...
            for (; a < t.length;) {
                ...
                const s = e[o],
                    c = lh(n, s, i.getContext(n, s, !0)),
                    l = lh(s, n, i.getContext(s, n, !1));
        ...
        function ph(t, e) {
            ...
            for (let i = 0; i < t.length; i++) {
                const o = t[i],
                    r = new pc(o.start, o.end.offset - o.start.offset, e, 0);
                n.push(r);
        ...
        ah(gc, gc, (t, e, n) => {
            ...
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                ...
                const i = new Ks(e.graveyardPosition.root, n),
                    o = yc.getInsertionPosition(new Ks(e.graveyardPosition.root, n)),
                    r = new yc(i, 0, null, 0);
        ...
        const of = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g, rf = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
        ...
        class _f extends Md {
            ...
            init() {
                ...
                this._enableAutomaticDecorators(n.filter(t => t.mode === bf)), this._enableManualDecorators(n.filter(t => t.mode === wf)),
                    function ({
                        view: t,
                        model: e,
                        emitter: n,
            ...
            _sendRequest() {
                ...
                return t.append("file", this.file), new Promise((n, i) => {
                    e.addEventListener("load", () => {
                        const t = e.status,
                            o = e.response;
                        return t < 200 || t > 299 ? o.message ? i(new Qn.b("fileuploader-uploading-data-failed: Uploading file failed.", this, {
                            message: o.message
                        })) : i(o.error) : n(o)
        ...
        class Df extends Md {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    priority: "low"
                }), t.addObserver(Of), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
        ...
        class tg extends Md {
            ...
            _createRotatorView() {
                const t = new eg(this.editor.locale),
            ...
            updatePosition() {
                if (this.numberOfPanels) {
                    const {
                        ...
                        width: n,
                        height: i
                    } = new Ps(this._balloonPanelView.element);
                    Object.assign(this, {
                        top: t,
                        left: e,
                        width: n,
        ...
        class Dg extends Md {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const i of e) i.model !== Rg && (t.model.schema.register(i.model, {
                    inheritAllFrom: "$block"
        ...
        class Bg extends Md {
            ...
            init() {
                ...
                o.downcastDispatcher.on("insert:caption", Fg(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const t of n)
                    if ("insert" == t.type && "$text" != t.name) {
                        ...
                        if (n.is("image") && !Vg(n) && i.push(n), !n.is("image") && n.childCount)
                            for (const t of e.createRangeIn(n).getItems()) t.is("image") && !Vg(t) && i.push(t)
        ...
        function tm(t) {
            if ("string" == typeof t) {
                const e = t;
                Jg[e] ? t = Object.assign({}, Jg[e]) : (console.warn(Object(Qn.a)("image-style-not-found: There is no such image style of given name."), {
                    name: e
                }), t = {
                    name: e
                })
        ...
        class em extends Md {
            ...
            init() {
                ...
                const r = function (t) {
                    return (e, n, i) => {
                        if (!i.consumable.consume(n.item, e.name)) return;
                        const o = Yg(n.attributeNewValue, t),
        ...
        class _m extends Rd {
            ...
            execute() {
                const t = this.editor.model,
                    e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e => ym(e, t.schema)),
                    i = !0 === this.value;
                t.change(t => {
                    if (i) {
        ...
        function Wm(t) {
            ...
            for (const n of t.getChildren())
                if ("ul" == n.name || "ol" == n.name)
                    for (const t of n.getChildren()) e += Wm(t);
            return e
        }
        ...
        class _p {
            ...
            execute(t) {
                const {
                    body: e,
                    stylesString: n
                } = pp(t.dataTransfer.getData("text/html"));
            ...
            return e => e.on("insert:table", (e, n, i) => {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = Up(Fp(n, d), a, i), c = o.getChild(n), l = h.get(n) || zp(c, n, s, i);
        ...
        function Np(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                ...
                const r = o.parent,
                    ...
                    d = new Map;
                for (const e of c) {
                    const n = Up(Fp(a, l), s, i),
                        r = d.get(a) || zp(o, a, n, i);
        ...
        function Rp(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                const r = Yp(i.mapper.toViewElement(o)),
                ...
                if (a > s) {
                    ...
                    for (const n of t)
                        for (const t of n.getChildren()) Lp(t, "th", i, e);
                    qp("tbody", r, i)
                } else {
                    Wp(Array.from(o.getChildren()).filter(({
                        index: t
                    }) => c(t, a - 1, s)).reverse(), Up("tbody", r, i), i, 0);
                    const t = new Pp(o, {
                            startRow: a ? a - 1 : a,
                            endRow: s - 1
                        }),
        ...
        function jp(t, e, n, i) {
            const {
                cell: o
            } = t, r = Bp(t, e), s = n.mapper.toViewElement(o);
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    for (const {
                            ...
                            column: n,
                            colspan: i
                        } of s) n <= a && i > 1 && n + i > a ? yp("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        class eb extends Rd {
        ...
        class kb extends Md {
            ...
            init() {
                ...
                n.register("table", {
                    ...
                    asWidget: !0
                })), i.for("dataDowncast").add(Np()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                    const i = n.writer,
                        o = n.mapper,
                    ...
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new ib(t)), t.commands.add("setTableRowHeader", new eb(t)), cb(e), bb(e), ub(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
        ...
        function Pb(t, e, n, i) {
            const o = t.model = new Lg(t.model),
                {
                    commandName: r,
                    bindIsOn: s
                } = t.model;
