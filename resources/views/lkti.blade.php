        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    <h2>Lomba Karya Tulis Ilmiah</h2>
                    <p style="text-align: justify">Lomba Karya Tulis Ilmiah merupakan kompetisi yang diselanggarakan oleh Kampoeng IT
                        5 2020. LKTI juga merupakan tulisan yang berisi gagasan kreatif yang disusun secara
                        komprehensif berdasarkan data akurat (terpercaya) dianalisis secara runtut, tajam dan
                        diakhiri dengan kesimpulan yang relevan</p>
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    ...
                    <a href="{{asset('public/rulebook/Rule Book - Umum LKTI With Template_compressed.pdf')}}" class="btn_2">Download Rulebook</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="learning_img">
                ...
                <div class="about_us_text">
                    <table class="table" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Tahap 1 : Pengiriman Abstrak</td>
                                <td>20 Februari 2020 - 07 Maret 2020</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Tahap 2 : Pengiriman Proposal</td>
