        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    <h2>Network Competition</h2>
                    <p style="text-align: justify">Network competition merupakan salah satu kempetisi yang ada di Kampoeng IT 5 2020 yang ditujukan bagi mahasiswa dan siswa se-indonesia. tujuan dari kompeiti ini adalah untuk menguji kemampuan analisa dan troubleshooting peserta mengenai jaringan komputer dengan simulasi cisco packet tracert</p>
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    ...
                    <a href="{{asset('public/rulebook/Rule Book - Mahasiswa Network Competition With Template_compressed.pdf')}}" class="btn_2">Download Rulebook Mahasiswa</a>
                    <br>
                    <br>
                    <a href="{{asset('public/rulebook/Rule Book - Siswa Network Competition With Template_compressed.pdf')}}" class="btn_2">Download Rulebook Siswa</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="learning_img">
                    <div style="text-align: justify">
                        ...
                        <br>
                        <p>Babak onsite akan dilaksanakan di Fakultas Ilmu Komputer Universitas Muslim Indonesia </p>
                        <br>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table" border="1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>20 Februari 2020 - 30 Maret 2020</td>
                            </tr>
                            <tr>
                                <td>Pendaftaran Offline</td>
                                <td>05 April - 16 April 2020</td>
                            </tr>
                            <tr>
                                <td>Babak Onsite</td>
                                <td>17 April 2020</td>
