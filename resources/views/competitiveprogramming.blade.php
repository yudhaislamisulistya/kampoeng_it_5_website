        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    ...
                    <p>Competitive Programming merupakan kompetisi pemrograman bersakala nasional yang
                        diselanggarakan oleh Kampoeng IT 5 Fakultas Ilmu Komputer, Universitas Muslim Indonesia</p>
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-md-6 col-lg-5">
                <div class="about_us_text">
                    ...
                    <a href="{{asset('public/rulebook/Rule Book - Mahasiswa Competitive Programming With Template_compressed.pdf')}}" class="btn_2">Download Rulebook</a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="learning_img">
                    <div style="text-align: justify">
                        ...
                        <br>
                        <p>Babak final tim akan langsung bertarung (onsite) dan mencari 3 terbaik dengan poin tertinggi</p>
                        <br>
                    </div>
                </div>
            </div>
                ...
                <div class="about_us_text">
                    <table class="table" border="1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Tahap 1 : Babak Penyisihan</td>
                                <td>07 Maret</td>
                            </tr>
                            <tr>
